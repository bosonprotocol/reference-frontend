        ...
        <ol className="chat">
            {data.map((message, index) => {
                ...
                return data[index - 1]?.account !==
                    ...
                    >
                        {
                            message.type == 'BUYER' ? <Identicon address={data[index].account} size={iconSize} /> : ""
                        }
                        <div className="msg">
                            <p className="address">
                                <span>{message.type == 'BUYER' ? shortenAddress(account) : "SELLER"}</span>
                            </p>
