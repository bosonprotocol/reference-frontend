export const IconCalendar = (props) => (
  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10.5 1.5H10V0.499969C10 0.22403 9.776 0 9.49997 0H9C8.72397 0 8.50003 0.22403 8.50003 0.499969V1.5H3.49997V0.499969C3.49997 0.22403 3.27603 0 3 0H2.50003C2.224 0 1.99997 0.22403 1.99997 0.499969V1.5H1.5C0.673004 1.5 0 2.173 0 3V10.5C0 11.327 0.673004 12 1.5 12H10.5C11.327 12 12 11.327 12 10.5V3C12 2.173 11.327 1.5 10.5 1.5ZM11 10.5C11 10.7755 10.7755 11 10.5 11H1.5C1.22452 11 1.00003 10.7755 1.00003 10.5V5.02002H11V10.5Z" fill={props.color ? props.color : '#5D6F84'}/>
  </svg>
)
