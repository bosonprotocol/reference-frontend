...
import { IconPhoto } from "../shared/Icons"
...
function UploadPhoto({inputValueReceiver, uploadImageErrorMessage}) {
  ...
  return ( 
    <div className="upload-photo">
      ...
      <div className={`image-upload-container flex ${sellerContext.state.offeringData && (getOfferingData(NAME.IMAGE) ? 'uploaded' : 'awaiting')}`}>
