...
import NewOfferBottomNavigation from "../../../new-offer/new-offer-bottom-navigation/NewOfferBottomNavigation";
        ...
        <nav className="flex">
          {navType === BOTTOM_NAV_TYPE.DEFAULT ? (
            ...
            <div className="offer-nav flex ai-center jc-end w100">
              <NewOfferBottomNavigation {...formNavigation} />
            </div>
          ) : navType === BOTTOM_NAV_TYPE.VOUCHER ? (
            <div className="control-wrap w100">
