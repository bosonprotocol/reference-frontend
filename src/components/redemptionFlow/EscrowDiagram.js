...
function EscrowDiagram(props) {
  ...
  const timePeriodText = (
    <>
      ...
      <p>
        Your deposit will be returned to your wallet in 7 days after Redeem.
        <br />
        Read our <span className="link">Terms of Service</span>.
      </p>
    </>
  );
      ...
      {escrowData ? (
        <section className="escrow-diagram vertical no-bg">
          ...
          <div className="semi-container">
            ...
            <div className="body">
              {Object.values(escrowData).map((row, key) => (
                <EscrowRow key={key} {...row} />
              ))}
            </div>
          </div>
