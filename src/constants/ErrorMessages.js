...
export const ErrorMessages = {
    ...
    ACCOUNT_OWNER_OF_VOUCHER_SET: 'The connected account is the owner of the voucher set.'
    
}

export const smartContractToUserFriendlyErrorMapping = new Map([
    ['UNDEFINED_OWNER', ({account}) => `Unauthorised access for this ${account}. Please check the connected wallet.`],
    ...
    ['INVALID_VALIDITY_TO', () => 'End date sent to the contract is invalid. Please try again and if the problem persist, file a bug report.'],
    ['INVALID_QUANTITY', () => 'Invalid voucher quantity sent to the contract. Please try again and if the problem persist, file a bug report.'],
    ...
    ['IN_D', () => 'Invalid deposit sent to the contract. Please try again and if the problem persist, file a bug report.'],
    ['IN_DE', () => 'Invalid deposit sent to the contract. Please try again and if the problem persist, file a bug report.'],
    ['ALREADY_COMPLAINED', () => 'You have already complained successfully. Please file a bug report if it takes more than a minute to see the relevant changes in the UI.'],
    ...
    ['ALREADY_PROCESSED', () => 'You have already redeemed this voucher successfully. Please file a bug report if it takes more than a minute to see the relevant changes in the UI.'],
])