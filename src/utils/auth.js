...
export const refreshTokenIfExpired = (rawToken, modalContext, library, chainId, account) => {
    ...
    if(!isTokenValid(rawToken)) {
        ...
        modalContext.dispatch(ModalResolver.showModal({
            ...
            content: 'Your authentication has expired. Please sign another authentication message.'
        }));

        // eslint-disable-next-line no-self-assign
        authenticateUser(library, account, chainId, () => {window.location = window.location});
    }
}
